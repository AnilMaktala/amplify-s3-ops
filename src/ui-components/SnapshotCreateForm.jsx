...
export default function SnapshotCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPlanYear(initialValues.planYear);
    ...
    setProjectRank(initialValues.projectRank);
    setProjectFunding(initialValues.projectFunding);
    setProjectHeadcount(initialValues.projectHeadcount);
    setInitiativeTitle(initialValues.initiativeTitle);
    setInitiativeDescription(initialValues.initiativeDescription);
    setOrganizationName(initialValues.organizationName);
    setOrganizationManagerAlias(initialValues.organizationManagerAlias);
    setOwnerAlias(initialValues.ownerAlias);
    setGoalTitle(initialValues.goalTitle);
    setGoalDescription(initialValues.goalDescription);
    setSnapshotPlanId(initialValues.snapshotPlanId);
    setSnapshotProjectId(initialValues.snapshotProjectId);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Snapshot(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "SnapshotCreateForm")}
      {...rest}
    >
      <TextField
        label="Timestamp"
